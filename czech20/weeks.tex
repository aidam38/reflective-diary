...
\raisebox{-0.3em}{\,\,\Annoey[2]\,\,\Sadey[2]\,\,\Changey[2]{0}\,\,\Changey[2]{1}\,\,\Changey[2]{2}}
}
...
Příprava:\hspace{1cm} hodin(y)\\
\note{Příprava materiálů, úkolů, pokynů, \ldots}
...
\note{Oslovování, (ne)formálnost, kladení otázek, začínání včas, \ldots}
\vspace*{1cm}
...
\marginsection{-90}{1}{volné poznámky}
\vspace*{-2em}
\note{Jaké znalosti a dovednosti chci naučit? Popiš je ve formátu rubriky, tedy pojmenuj dovednost a popiš škálu (viz str.\ \pageref{rubric}).\\
...
Jak poznám, že se cílů podařilo dosáhnout?\\
\note{Existuje způsob, kterým je možné zjistit, zda jsi cíle dosáhl(a)?}
...
\marginsection{-90}{1}{volné poznámky}
\vspace*{-2em}
\note{Podařilo se mi naplnit cíle hodiny?\\
...
\note{Kde v mojí výuce se dotýkám jiných kurzů nebo jiných oblastí vědění?}
...
\marginsection{-90}{1}{volné poznámky}
\vspace*{-2em}
\note{Za jaké znalosti a dovednosti jsou studenti hodnoceni u zkoušky?\\
...
\note{Co pro mě nebo studenty nefungovalo?}\\
Co by mělo další semestr zůstat stejné?

\newpage
\marginsection{-90}{1}{volné poznámky}
\vspace*{-2em}
\note{Co fungovalo pro mé kolegy?\\
